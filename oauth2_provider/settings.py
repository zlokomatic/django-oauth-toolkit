...
DEFAULTS = {
    ...
    "OAUTH2_ACCESS_TOKEN_GENERATOR": "oauth2_provider.generators.signed_token_generator",
    "OAUTH2_REFRESH_TOKEN_GENERATOR": "oauth2_provider.generators.signed_token_generator",
